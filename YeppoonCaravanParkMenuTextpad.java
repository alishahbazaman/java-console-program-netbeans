...
public class YeppoonCaravanParkMenuTextpad
{
	...
	final int MAX_BOOKINGS = 3;	// TODO -- declare any further constants
	...
	private void enterBooking()
	{
		...
		else
		{
			...
			for (int i = 0; i < 1; i++)
			{
				...
				// TODO -- create validation loop (do this after getting the other functionality working)
				System.out.printf("Please enter the number of nights ==> " );
				...
				// TODO -- create validation loop (do this after getting the other functionality working)
				System.out.printf("Please enter the number of guests ==> " );
	...
	{
		System.out.printf("%n%-30s%-11s%-11s%-6s\n", "Booking Name", "Nights", "Guests", "Charge");
	...
	{
		System.out.printf("%-30s%-11d%-11d%-6.2f\n", bookingArray[index].getBookingName(), bookingArray[index].getNights(),
													bookingArray[index].getGuests(), bookingArray[index].calculateCharge());
	}
	...
	private void sortBookings()
	{
		...
		else
		{
			for(int next = 1; next < bookingArray.length; next++)
			{
				...
				// TODO -- sort the entries based on the booking name (case insensitve)
	...
	{
		System.out.printf("Welcome to the Yeppoon Caravan Park Management System%n%n"); // welcome message

		YeppoonCaravanParkMenuTextpad app = new YeppoonCaravanParkMenuTextpad();
